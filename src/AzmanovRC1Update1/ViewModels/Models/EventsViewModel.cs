...
namespace Azmanov.ViewModels
{
    ...
    {
        private IPager<Event, EventDisplayViewModel> _pager;

        public PagingResult<EventDisplayViewModel> PagingResult { get; set; }
        public EventsViewModel(ILanguageRepository languageRepository,
            ILanguageViewModelFactory languageViewModelFactory,
            IMenuRepository menuRepository,
            IMenuViewModelFactory menuViewModelFactory ,
            IPager<Event, EventDisplayViewModel> pager)
            : base(
                  languageRepository,
